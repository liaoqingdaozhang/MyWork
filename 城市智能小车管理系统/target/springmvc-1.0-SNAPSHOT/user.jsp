            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center sorting">注册时间
                                    ...
                                    <span @click="orderFn('price', true)">↓</span></th>
                            ...
                            <tr v-for="u in list">
                                ...
                                <td>{{u.phone}}</td>
                                <td>{{u.card}}</td>
                                <td class="text-center">{{u.registertime}}</td>
                                                ...
                                                <div class="box-body">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" v-model="user.card">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">注册时间:</label>
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" v-model="user.registertime">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新"  @click="myrefresh"><i
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback" style="text-align: center;margin: 0px auto">
                                <input type="text" class="searchBox" v-model="search">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a @click="findAll(1,4)" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="#">上一页</a></li>
                            <li><a href="#">1</a></li>
                            <li><a href="#">2</a></li>
                            ...
                            <li><a href="#">下一页</a></li>
                            <li>
                                <a  @click="findAll(2,4)" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
